...
const Layout = ({ children, titlePage }) => {
    return (
        <div class="w-full h-screen bg-zinc-100">
            <div className='w-full bg-grey-100 p-4 shadow text-2xl block fixed bg-white shadow h-14 md:h-16 z-10'>
                <p className='text-base md:text-lg lg:md:text-xl'>{titlePage}</p>
            </div>
            <main className='py-16 overflow-x-hidden bg-zinc-100'>{children}</main>
            <section id="bottom-navigation" class="block fixed inset-x-0 bottom-0 bg-white shadow h-16">
                <div id="tabs" class="flex justify-between">
                    <Link href="/">
                        <a class="w-full focus:text-blue-500 hover:text-blue-500 justify-center inline-block text-center pt-2 pb-1">
                            ...
                            <span class="tab tab-home block text-xs">Informations</span>
                        </a>
                    </Link>
                    <Link href="/application">
                        <a href="#" class="w-full focus:text-blue-500 hover:text-blue-500 justify-center inline-block text-center pt-2 pb-1">
                            <svg width="25" height="25" viewBox="0 0 42 42" class="inline-block mb-1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <span class="tab tab-kategori block text-xs">Applications</span>
                        </a>
                    </Link>
                    <Link href="/profil">
                        <a href="#" class="w-full focus:text-blue-500 hover:text-blue-500 justify-center inline-block text-center pt-2 pb-1">
